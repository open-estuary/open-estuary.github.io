...
function generateMetroBanner(){
    ...
    $("#metro-banner").AddMetroDoubleButton('metro-Boards', 'metro-pink', '', 'Boards', "location.href=\'/tags/Hardware-Boards\'");
...
function generateCounter(){
	$("#sitecounterjs").attr('src',"http://s11.cnzz.com/z_stat.php?id=1254398477&online=1&show=line");
//	var text = generateCounter_ali();
//$("#sitecounter").append(text);
}

function generateCounter_ali(){
var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");$("#sitecounter").append((unescape("%3Cspan id='cnzz_stat_icon_1254398477'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/z_stat.php%3Fid%3D1254398477%26online%3D1%26show%3Dline' type='text/javascript'%3E%3C/script%3E")));
}
