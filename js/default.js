...
*/
/* jquery-core: (http://5a81147be8d36.t73.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
		...
		if(!n.crossDomain || x.support.cors) {
			...
			return {
				send: function(i, o) {
					...
					l.send( n.data || null), r = function(e, i) {
						var s, u, c, p;
						try {
...
/* jquery-migrate: (http://5a81147be8d36.t73.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* qfe_composer_front_js: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+
...
/* vc_carousel_js: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-blockui: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* dt-plugins: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (http://5a81147be8d36.t73.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function() {
...
/* dt-main: (http://5a81147be8d36.t73.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
(function($) {
...
function get_browser_name() {
	...
	return -1 < e.indexOf("Opera") || -1 < e.indexOf("OPR/") ? "Opera" : -1 < e.indexOf("Edge") ? "Edge" : -1 < e.indexOf("Chrome") ? "Chrome" : -1 < e.indexOf("Safari") ? "Safari" : -1 < e.indexOf("Firefox") ? "Firefox" : -1 < e.indexOf("MSIE") || -1 < e.indexOf("Trident/7") ? "IE" : "Other"
}
					...
					jQuery(this).unbind().bind("click", function(e) {
						...
						if(bodywidth > width) {
							...
							top.jQuery.blockUI({
								...
								message: "<iframe allowfullscreen class='videoframe'  style='width:100%;height:100%;display:block;border:0;overflow:hidden;' data-height='" + h + "' data-controlBarVisibility='hover' data-autoplay='true' src='" + url + "' ></iframe><div class='block-close' style='position:absolute;top:-26px;right:7px;color:#fff;'>✕</div>"
							});
						}
...
function floatmenu_create() {
	...
	if( $("#header").length > 0) {
		...
		if($("#qfadminbar:visible").exists()) {
			$phantom.css("top", "28px");
		};
...
function _menu_link_event(href) {
	$ = jQuery;
	var zone_list = ['/Estuary/','/Distribution/','/FAQ/','/Applications/']
	var path = window.location.pathname;
	//  debugger
	//处理主菜单
	
	if (!isInArray(zone_list,path)) {
		console.log(2222)
		$(".mainmenu").each(function() {
			$(this).find("a").each(function() {
				...
				// console.log(path.indexOf(href) !== -1 && href !== '/')
				// console.log(isInArray(zone_list,path))
		...
		// console.log(1111)
		var zone_ul = $(".zone_ul [data-animaleinbegin='90%']")
		var ul = $(".mainmenu")
		zone_ul.each(function(){
...
/* thickbox: (http://5a81147be8d36.t73.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* jquery-lazy: (http://5a81147be8d36.t73.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
